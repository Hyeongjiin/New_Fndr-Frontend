...
export default {
  ...
  data() {
    return {
      ...
      tag_list: [],
      post: {
        nation_id: this.$store.state.jobDetail.nation_id,
        company_name: this.$store.state.jobDetail.company_name,
        description_title: this.$store.state.jobDetail.description_title,
        description_content: this.$store.state.jobDetail.description_content,
        company_apply_link: this.$store.state.jobDetail.company_apply_link,
        is_visa_sponsored: this.$store.state.jobDetail.is_visa_sponsored,
        is_remoted: this.$store.state.jobDetail.is_remoted,
        company_page_link: this.$store.state.jobDetail.company_page_link,
        tag: "",
  ...
  methods: {
    ...
    validateRadio(fieldName) {
      if (this.post[fieldName] === null || this.post[fieldName] === "[]") {
    ...
    async submitUpdateForm(postId) {
      ...
      try {
        ...
        if (
          ...
          if (!newCompanyLogo) {
            newCompanyLogo = this.$store.state.jobDetail.company_logo;
          }
