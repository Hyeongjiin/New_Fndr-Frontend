<template>
  <div class="card">
    ...
    <section>
      <div class="info" v-html="jobDetail.description_content">
      </div>
    </section>
  </div>
</template>
  ...
  computed: {
    tagsArray() {
      try {
        ...
        const techNameArray = this.jobDetail.description_teches.map(tech => tech.tech_name); // description_teches에서 tech_name만 추출
