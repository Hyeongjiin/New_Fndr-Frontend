<template>
  <div class="editBox">
    ...
    <form
      class="form"
      @submit.prevent="submitUpdateForm(this.$store.state.user.id)"
      novalidate
    >
      <div class="row">
        <fieldset disabled>
      ...
      <div class="btn-box">
        <div>
          <ul>
            <li data-bs-toggle="modal" data-bs-target="#passwordChangeModal">
              Change Password
            </li>
            <li>|</li>
            <li data-bs-toggle="modal" data-bs-target="#accountDeleteModal">
              Delete this account
            </li>
          </ul>
        </div>
      ...
      <form>
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" @click="changePassword" class="btn post">
              Change
            </button>
            <button
              type="button"
  ...
  >
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="accountDeleteModalLabel">
            Delete Account
          </h5>
          <button
            type="button"
        ...
        <div class="modal-body">
          ...
          <div class="form-check mt-3">
            ...
            <label class="form-check-label" for="deleteConfirmCheckbox"
              >I understand the consequences and want to delete my
              account.</label
            >
          </div>
        </div>
