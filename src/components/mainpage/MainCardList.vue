  ...
  <li class="main-recruit">
    ...
    <base-card v-for="remote in articles.Remote.slice(0, remoteToShow)" :key="remote.id">
      ...
      <ul class="info">
        ...
        <li v-if="remote.is_remoted === true"><i class="bi bi-house-check"></i> Remote</li>
        <li v-if="remote.is_visa_sponsored === true"><i class="bi bi-card-checklist"></i> Visa sponsored</li>
      </ul>
    </base-card>
    ...
    <base-card v-for="visa in articles.Visa.slice(0, visaToShow)" :key="visa.id">
      ...
      <ul class="info">
        ...
        <li v-if="visa.is_remoted === true"><i class="bi bi-house-check"></i> Remote</li>
        <li v-if="visa.is_visa_sponsored === true"><i class="bi bi-card-checklist"></i> Visa sponsored</li>
      </ul>
    </base-card>
  </li>
